...
public class C1_DateTimeFormatter {
	...
	public static void main(String[] args) {
        ...
        LocalDate dogumTarihi = LocalDate.of(1996, 4, 8);
        LocalDate bugun = LocalDate.now();
        
        
        Period benimYasim = Period.between(dogumTarihi, bugun);// P24Y11M13D yerini deðiþtirirsen int yas da eksi sonuç alýrsýn 
